    ...
    <ImageBackground source={background} style={styles.background}>
      ...
      <View style={styles.container}>
        ...
        <View style={styles.facultyContainer}>
          <TouchableOpacity
            style={[styles.facultyItem, selectedFaculty === 'engineering' && styles.selectedFaculty]}
            onPress={() => handleFacultySelection()}
          >
            <FontAwesomeIcon icon={faCogs} style={styles.facultyIcon} />
            <Text style={styles.facultyText}>Engineering</Text>
          </TouchableOpacity>
          <TouchableOpacity
            style={[styles.facultyItem, selectedFaculty === 'architecture' && styles.selectedFaculty]}
            onPress={() => handleFacultySelection()}
          >
            <FontAwesomeIcon icon={faBuilding} style={styles.facultyIcon} />
            <Text style={styles.facultyText}>Architecture</Text>
          </TouchableOpacity>
          <TouchableOpacity
