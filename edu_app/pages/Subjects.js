    ...
    <ImageBackground source={background} style={styles.background}>
      ...
      <View style={styles.container}>
        ...
        <View style={styles.facultyContainer}>
          <TouchableOpacity
            style={[styles.facultyItem, selectedFaculty === 'MAths' && styles.selectedFaculty]}
            onPress={() => handleFacultySelection()}
          >
            <FontAwesomeIcon icon={faCogs} style={styles.facultyIcon} />
            <Text style={styles.facultyText}>MAths</Text>
          </TouchableOpacity>
          <TouchableOpacity
            style={[styles.facultyItem, selectedFaculty === 'OS' && styles.selectedFaculty]}
            onPress={() => handleFacultySelection()}
          >
            <FontAwesomeIcon icon={faBuilding} style={styles.facultyIcon} />
            <Text style={styles.facultyText}>OS</Text>
          </TouchableOpacity>
